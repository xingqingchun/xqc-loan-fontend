<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="formatedData" size="small" border style="width: 100%;">
                        ...
                        <el-table-column prop="orderAmt" label="订单金额"/>
                        <el-table-column prop="incomeAmt" label="商户实收金额"/>
                        <el-table-column prop="feeAmt" label="渠道费用金额"/>
                        <el-table-column prop="reducedAmt" label="优惠金额"/>
...
<script>
    ...
    computed: {
        ...
        methods: {
            parseTime,
            beforeInit() {
                this.url = '/adjust/adjustBillFileDetail/queryPage'
            ...
            subDelete(id) {
                ...
                doGet('/adjust/adjustBillFileDetail/delete?id=' + id).then(res => {
